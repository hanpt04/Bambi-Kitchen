...
public class DumpDataController {
    ...
    {
        ingredientCategoryService.save(new IngredientCategory(  "Hải sản", "Ngon" ));
        ingredientCategoryService.save(new IngredientCategory( "Rau và Cỏ", "Hành Tinh Bò" ));
        ingredientCategoryService.save(new IngredientCategory(  "Thịt", "G O A T" ));
        ingredientCategoryService.save(new IngredientCategory(  "Tinh Bột", "No" ));
        ingredientCategoryService.save(new IngredientCategory( "Trái cây", "Cung cấp vitamin"));
        ingredientCategoryService.save(new IngredientCategory( "Hạt & Đậu", "Giàu chất xơ và béo tốt"));
        ingredientCategoryService.save(new IngredientCategory( "Nấm", "Tăng hương vị umami"));
        ingredientCategoryService.save( new IngredientCategory( "Nước", "Chất lỏng"));
    }
